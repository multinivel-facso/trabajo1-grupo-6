...
## Test de devianza {.big}

```{r}
anova(model3, model4) |> 
  as.data.frame() |> 
  gt() |> 
  tab_header(title = "Test de anova: comparación de modelos con pendiente fija y aleatoria")
```
...
::: {.column width="30%"}
Texto explicativo del gráfico. Puedes detallar aquí los efectos aleatorios según comuna.
:::
:::::
